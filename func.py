...
K_TEMP = 273  # Coef. for conv. temp. from degrees Celsius to degrees Kelvin.
...
def calculator_1(value: float,
    ...
    temperature = temperature + K_TEMP  # Conv. temp. from Celsia to Kelvin.
...
def calculator_2(mass: float) -> str:
    # Функция № 2
    # вычислени объема водорода (в м куб.) при стандартных условиях:
...
def calculator_3(value: float) -> str:
    # Функция № 3
    # вычисление массы водорода (в кг) при стандартных условиях:
    # температура: 21 градус цельсия
    # давление: 1 атм
